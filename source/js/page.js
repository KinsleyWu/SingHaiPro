    ...
    (function(_win) {  
        ...
        var _p = {  
            ...
            fillHtml : function(obj, args) {  
                var html = "<img src='img/left-all.png' id='firstPage' style='margin-right: 10px;'/>"  
                    + "<img src='img/left.png' id='previousPage' style='margin-right: 10px;'/> "  
                    + "第<input id='pageNo' min='1' max='999' value='1' style='width:50px;'/>页<span id='totalPage'>（共<span id='pageCount'>999</span>页）</span>"  
                    + "<img src='img/right.png' id='nextPage' style='margin-right: 10px;' /> "  
                    + "<img src='img/right-all.png' id='lastPage' style='margin-right: 10px;'/>";  
